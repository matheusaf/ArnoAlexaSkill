...
from commands import ArnoCommand, ArnoCommandDecoder, ArnoCommandEncoder
...
BACKEND_BASE_URL = "http://192.168.15.31:9999/arno"

MAX_ITEMS_STACK = 15

TIME_INTERVAL_SEC = 0

CUR_TIMEZONE_NAME = "America/Sao_Paulo"
...
file_logger.setFormatter(
    lg.Formatter(
        "(%(asctime)s)[%(levelname)s:%(name)s] %(module)s.%(filename)s.%(funcName)s => | %(message)s |"
    )
)
